...
describe('DonationRequest', (done) => {
  ...
  describe('/POST api/DonationRequest ', function() {
    ...
    it('it should post one donation response with a valid donation request', (done) => {
      ...
      .end((err, donReq) => {
        ...
        .send({
            ...
            donnerId: "5b02f7654fa6800b14a094be",
            donnerReviewId: "5b02f76a4fa6800b14a094c5" 
        })
        .end((err, res) => {
          res.body.should.be.a('object');
          res.should.have.status(200);
    ...
    it('it should fail adding a new permanent donationrequest: expiration date must be 30 days greater than creation date', (done) => {
      chai.request(server).post('/api/DonationRequests')
        .send({
          // no importa que se manda, siempre va a tomar la fecha actual
          creationDate: '2018-04-12',
    ...
    it('it should fail adding a new onetime donationrequest: expiration date must be 2 days greater than creation date', (done) => {
      chai.request(server).post('/api/DonationRequests')
        .send({
          // no importa que se manda, siempre va a tomar la fecha actual
          creationDate: '2018-04-12',
    ...
    it('it should fail posting one donation request: no atributes defined', (done) => {
      chai.request(server)
      .get('/api/DonationRequests')
      .end((err, donReq) => {
        chai.request(server).post('/api/DonationRequests')
    ...
    it('it should fail posting one donation request: unexpected atributes', (done) => {
      chai.request(server)
      .get('/api/DonationRequests')
      .end((err, donReq) => {
        chai.request(server).post('/api/DonationRequests/'+donReq.body[0].id)
          .send({
            creationDate: '2017-01-12',
            amount: 10,
            expirationDate: '2100-04-25',
  ...
  this.timeout(100000);
    ...
    it('it should patch one donation request', (done) => {
      ...
      .get('/api/DonationRequests')
      .end((err, donReq) => {
        chai.request(server).patch('/api/DonationRequests/'+donReq.body[0].id)
        .send({
            // no importa que se manda, siempre va a tomar la fecha actual
            creationDate: '2018-04-12',
            amount: 10,
    ...
    it('it should fail patching one donation request: expiration date must be 2 days greater than creation date', (done) => {
      // recupero los Donation Request que cree antes
      chai.request(server)
      .get('/api/DonationRequests')
      .end((err, donReq) => {
    ...
    it('it should patch one permanent donation request', (done) => {
      ...
      .get('/api/DonationRequests')
      .end((err, donReq) => {
        chai.request(server).patch('/api/DonationRequests/'+donReq.body[1].id)
        .send({
            // no importa que se manda, siempre va a tomar la fecha actual
            creationDate: '2018-04-12',
            amount: 10,
    ...
    it('it should fail patching one permanent donation request: expiration date must be 30 days greater than creation date', (done) => {
      // recupero los Donation Request que cree antes
      chai.request(server)
      .get('/api/DonationRequests')
      .end((err, donReq) => {
    ...
    it('it should not patch pedido with amount < covered', (done) => {
      ...
      .get('/api/DonationRequests')
      .end((err, donReq) => {
        chai.request(server).patch('/api/DonationRequests/'+donReq.body[2].id)
        .send({
    ...
    it('it should fail patching one donation request: unexpected atributes', (done) => {
      chai.request(server)
      .get('/api/DonationRequests')
      .end((err, donReq) => {
        chai.request(server).patch('/api/DonationRequests/'+donReq.body[0].id)
  ...
  this.timeout(100000);
    ...
    it('it should delete one donation request', (done) => {
      ...
      .get('/api/DonationRequests')
      .end((err, donReq) => {
          chai.request(server).delete('/api/DonationRequests/'+donReq.body[1].id)
          .send({})
          .end((err, res) => {
              res.body.should.be.a('object');
              res.should.have.status(200);
    ...
    it('it should fail delete donation request: could not find donation request', (done) => {
    ...
    it('it should fail delete donation request: donnation request has a donation response', (done) => {
      chai.request(server)
      .get('/api/DonationRequests')
      .end((err, donReq) => {
          chai.request(server).delete('/api/DonationRequests/'+donReq.body[0].id)
          .send({})
          .end((err, res) => {
              res.body.should.be.a('object');
              res.should.have.status(400);
  ...
  this.timeout(100000);
      ...
      it('it should close request', (done) => {
        ...
        .get('/api/DonationRequests')
        .end((err, donReq) => {
            chai.request(server).post('/api/DonationRequests/'+donReq.body[0].id+"/closeRequest")
            .send({
                undefined: {}
            })
            .end((err, res) => {
